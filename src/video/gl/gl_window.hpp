...
#ifndef _HEADER_HARBOR_VIDEO_GL_GLWINDOW_HPP
#define _HEADER_HARBOR_VIDEO_GL_GLWINDOW_HPP
...
{
public:
  GLWindow(const Size& size = Size(640, 400), bool visible = true);
  virtual ~GLWindow();
